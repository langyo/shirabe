...
Luego, controla el servidor en ejecución a través de HTTP:
...
Consulta [Backends y resolución](./backends.md) para saber cómo se encuentra un ejecutable, y [Empaquetado de bibliotecas nativas](./bundling.md) para distribuir un producto autónomo.
