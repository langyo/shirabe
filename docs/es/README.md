...
<p align="center"><strong>Automatización de navegadores, reimaginada — control headless de la familia Chromium mediante CDP, con un resolutor de backend sin configuración al estilo ort.</strong></p>
