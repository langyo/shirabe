...
<p align="center"><strong>L'automatisation de navigateur repensée — contrôle headless de la famille Chromium via CDP, avec un résolveur de backend sans configuration façon ort.</strong></p>
