...
<p align="center"><strong>أتمتة المتصفح، بتصوّر جديد — تحكّم بمتصفحات عائلة Chromium بدون واجهة عبر CDP، مع محلّل خلفية تلقائي على غرار ort.</strong></p>
...
SySL-1.0 (رخصة المصدر الاصطناعي). راجع [LICENSE](../../LICENSE).
